...
class Clubs(models.Model):
    ...
    season = models.TextField(blank=True, null=True)  # This field type is a guess.
    standing = models.TextField(blank=True, null=True)  # This field type is a guess.
    matches = models.TextField(blank=True, null=True)  # This field type is a guess.
    biography = models.CharField(max_length=65651, blank=True, null=True)
    trophies = models.TextField(blank=True, null=True)  # This field type is a guess.
